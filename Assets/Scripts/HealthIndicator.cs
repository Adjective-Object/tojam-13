...
public class HealthIndicator : MonoBehaviour {
	...
	private int mHealthChangeListenerID;
	...
	void Start () {
		...
		mHealthChangeListenerID = health.RegisterChangeListener(this.OnHealthChanged);
	}

	void OnDestroy() {
		health.DeRegisterChangeListener(this.mHealthChangeListenerID);
	}
